# SCRIBBLE
In this project, I have implemented two versions of a wordgame!
...
In one of the version ,the user is player. Where as in the other version the user can be a player or a computer.
